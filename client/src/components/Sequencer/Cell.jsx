...
const Cell = styled.div.attrs(({ activated, triggered, row }) => ({
  ...
  /* Base cell styling - SMALLER SIZE */
  width: 4rem; /* Reduced from 5rem to 4rem */
  ...
  /* Cool dotted background pattern */
  /* Removed - dots will be on main sequencer background instead */
  ...
  ${theme.media.mobile} {
    width: 2.5rem; /* Even smaller on mobile */
    height: 2.5rem;
    margin: 1px;
